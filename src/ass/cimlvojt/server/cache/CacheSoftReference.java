...
public class CacheSoftReference implements CacheInterface<String, CacheObject>{
	...
	public CacheSoftReference(long cacheCapacity){
		this.cacheCapacity = cacheCapacity;
		startCleaner();
	}	
	
	public CacheSoftReference(long cacheCapacity, int maximumCacheObjectAge){
		this.cacheCapacity = cacheCapacity;
